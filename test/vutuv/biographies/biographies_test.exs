defmodule Vutuv.BiographiesTest do
  ...
  describe "profiles" do
    ...
    @valid_attrs %{active_slug: "some active_slug", avatar: "some avatar", birthday_day: 42, birthday_month: 42, birthday_year: 42, first_name: "some first_name", gender: "some gender", headline: "some headline", honorific_prefix: "some honorific_prefix", honorific_suffix: "some honorific_suffix", last_name: "some last_name", locale: "some locale", middlename: "some middlename", nickname: "some nickname", noindex?: true, validated?: true, verified: true}
    @update_attrs %{active_slug: "some updated active_slug", avatar: "some updated avatar", birthday_day: 43, birthday_month: 43, birthday_year: 43, first_name: "some updated first_name", gender: "some updated gender", headline: "some updated headline", honorific_prefix: "some updated honorific_prefix", honorific_suffix: "some updated honorific_suffix", last_name: "some updated last_name", locale: "some updated locale", middlename: "some updated middlename", nickname: "some updated nickname", noindex?: false, validated?: false, verified: false}
    @invalid_attrs %{active_slug: nil, avatar: nil, birthday_day: nil, birthday_month: nil, birthday_year: nil, first_name: nil, gender: nil, headline: nil, honorific_prefix: nil, honorific_suffix: nil, last_name: nil, locale: nil, middlename: nil, nickname: nil, noindex?: nil, validated?: nil, verified: nil}
    ...
    test "update_profile/2 with valid data updates the profile" do
      ...
      assert profile.validated? == false
    ...
    test "delete_profile/1 deletes the profile" do
      ...
      assert_raise Ecto.NoResultsError, fn -> Biographies.get_profile!(profile.id) end
    end
