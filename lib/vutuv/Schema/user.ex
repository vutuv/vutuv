defmodule Vutuv.User do
    ...
    schema "users" do
      ...
      has_many :email_addresses,  Vutuv.EmailAddress, on_delete: :delete_all
    ...
    def changeset(user, attrs) do
      user
      |> cast(attrs, [:first_name, :last_name, :middlename, :nickname, :honorific_prefix, :honorific_suffix, :gender, :birthday_day, :birthday_month, :birthday_year, :locale, :verified, :avatar, :active_slug, :headline, :noindex?, :validated?])
      |> validate_required([:gender, :local, :birthday_day, :birthday_month])
